    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                route: "SkillSettings",
                children: [
                    { label: "Skill Point Check", icon: "ellipse-outline", route: "SkillPlanSettingsSkillPointCheck" },
                    { label: "Pre-Finals", icon: "ellipse-outline", route: "SkillPlanSettingsPreFinals" },
                    { label: "Career Complete", icon: "ellipse-outline", route: "SkillPlanSettingsCareerComplete" },
                ],
            },
        ],
    },
...
const SETTINGS_STACK_ROUTES = new Set<string>([
    ...
    "SkillSettings",
    "SkillPlanSettingsSkillPointCheck",
