...
const searchConfig: SearchOption[] = [
    ...
    {
        id: "unique-race-irregular-training-min-stat-gain",
        title: "Unique Race Irregular Training Minimum Stat Gain",
        description: "Per-race minimum main stat gain override for irregular training.",
        page: "UniqueRaceSettings",
    ...
    {
        id: "trackblazer-irregular-training-min-stat-gain-g1",
        title: "G1 Irregular Training Minimum Stat Gain",
        description: "Minimum main stat gain for irregular training on G1 race days.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training",
    },
    {
        id: "trackblazer-irregular-training-min-stat-gain-g2",
        title: "G2 Irregular Training Minimum Stat Gain",
        description: "Minimum main stat gain for irregular training on G2 race days.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training",
    },
    {
        id: "trackblazer-irregular-training-min-stat-gain-g3",
        title: "G3 Irregular Training Minimum Stat Gain",
        description: "Minimum main stat gain for irregular training on G3 race days.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training",
    },
    {
    ...
    {
        id: "trackblazer-enable-irregular-training-agenda-pre-debut",
        title: "Allow Agenda Irregular During Pre-Debut",
        description: "Include pre-debut turns (1–11) in agenda irregular evaluation and autofill schedule recording.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training-with-agenda",
    },
    {
        id: "trackblazer-enable-irregular-training-agenda-pre-op",
        title: "Allow Pre-Op / OP Agenda Irregular Training",
        description: "Pre-Op and OP agenda race days use G3 minimum stat gain thresholds when evaluating irregular training.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training-with-agenda",
    },
    {
        id: "trackblazer-agenda-irregular-autofill",
        title: "Autofill Agenda Schedule From Runs",
        description: "First full career run records agenda races without irregular training on those days; schedule becomes ready after career complete.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training-with-agenda",
    },
    {
        id: "trackblazer-agenda-irregular-mark-ready",
        title: "Mark Agenda Irregular Schedule Ready",
        description: "Manually mark the learned or edited agenda race schedule ready for irregular training.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training-with-agenda",
    },
    {
        id: "trackblazer-agenda-irregular-clear",
        title: "Clear Agenda Irregular Schedule",
        description: "Clear the mapped turn-to-race schedule for the current agenda.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training-with-agenda",
    },
    {
        id: "trackblazer-agenda-irregular-lock-schedule",
        title: "Lock Agenda Irregular Schedule",
        description: "Prevent manual edits to the agenda race schedule. Autofill can still append new turns.",
        page: "ScenarioOverridesSettings",
        parentId: "trackblazer-enable-irregular-training-with-agenda",
    },
    {
